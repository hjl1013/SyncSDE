...
from syncsde.synctweedies.diffusion.controlnet import SyncTweediesControlNet
from syncsde.synctweedies.diffusion.stable_diffusion import SyncTweediesSD
...
class BaseModel(metaclass=ABCMeta):
    ...
    def initialize(self):
        ...
        save_dir = self.config.results_folder
        save_dir_now = self.config.save_dir_now 
        
        if save_dir_now:
            self.output_dir = Path(save_dir) / f"{now}"
        else:
