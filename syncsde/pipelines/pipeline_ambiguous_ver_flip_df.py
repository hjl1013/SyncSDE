    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                ver_flipped_latent_1 = torch.zeros_like(intermediate_images[0:1])
                for h_window in range(64):
                    for w_window in range(64):
                        ver_flipped_latent_1[:, :, h_window, w_window] = old_latents[0:1, :, 63 - h_window, w_window]
                    
                intermediate_images[1:2] = intermediate_images[1:2] - gamma_t * inv_lambda * (t.item() / T) * (old_latents[1:2] - ver_flipped_latent_1)
